		...
		<form method="POST" action="/report/new">
						...
						<div class="col">
							<div class="card shadow mb-3">
								...
								<div class="card-body">
									...
									<div class="row">
										<div class="col">
											<label class="form-label" for="username"><strong>{{ __( 'investigation-involved' ) }}:</strong><br/></label>
							...
							<div class="card shadow">
								...
								<div class="card-body">
									<div class="row">
										<div class="col">
											<textarea class="form-control" name="evidence" id="evidence" rows="5">
												{{ old( 'evidence' ) }}
											</textarea>
										</div>
									</div>
			...
			<div class="card shadow mb-5">
				...
				<div class="card-body text-center">
					...
					<button class="btn btn-primary" type="submit" style="padding: 4px 8px; margin: 10px 0 0 25px;">
						<i class="fa-solid fa-triangle-exclamation fa-sm text-white-50"></i> {{ __( 'submit' ) }}
					</button>
				</div>
			</div>
		</form>
